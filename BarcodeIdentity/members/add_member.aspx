                    ...
                    <div class="middle-wrap">
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div class="card-body p-4 w-100 bg-current border-0 d-flex rounded-3">
                                ...
                                <h4 class="font-xs text-white fw-600 ms-4 mb-0 mt-2">Add Member</h4>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="firstnametxt" required="required" runat="server" class="form-control">
                                        </div>        
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" required="required" id="emailtxt" runat="server" class="form-control">
                                        </div>        
                                    </div>
...
<%--                                                    <input type="file" name="file" id="file" class="input-file">--%>
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        ...
                                        <textarea class="form-control mb-0 p-3 h100  lh-16" rows="5" id="abouttxt" runat="server" placeholder="Write a brief information about yourself..." spellcheck="true"></textarea>
                                    </div>

                                    <div class="col-lg-12">
                                        <asp:Button ID="Button1" OnClick="AddMemmber" class="bg-current text-center text-white font-xsss fw-600 p-3 w175 rounded-3 d-inline-block" runat="server" Text="Add Member" />
                                    </div>
                                </div>
