...
<%--                                        <a id="btn-Preview-Image1" type="button" href="#" class="d-none d-lg-block bg-success p-3 z-index-1 rounded-3 text-white font-xsssss text-uppercase fw-700 ls-3">Download ID</a>--%>
                                            <input download="download.png" type="button" class="d-none d-lg-block bg-success p-3 z-index-1 rounded-3 text-white font-xsssss text-uppercase fw-700 ls-3" value="Download ID" />
