<%@ Page Title="" Language="C#" MasterPageFile="~/account/barcode.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="default.aspx.cs" Inherits="BarcodeIdentity.shop._default" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>QrId - Personal ID Suite - Shop</title>
</asp:Content>
                        ...
                        <div class="col-xl-12 col-xxl-12 col-lg-12 pe-0">
                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3 mt-3">
                                <div class="card-body d-block p-4">
                                    <h2 class="fw-700 mb-3 font-lg text-grey-900">Keep Fit Shop</h2>
                                    <p class="fw-500 text-grey-500 lh-24 font-xssss mb-0">Something good is coming...</p>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card w-100 border-0 mt-4">
                                        ...
                                        <div class="card-body w-100 p-0 text-center">
                                            ...
                                            <h2 class="mt-1 mb-1"><a href="#" class="text-black fw-700 font-xsss lh-26">Keep Fit Hand Band</a></h2>
                                            <h6 class="font-xsss fw-600 text-grey-500 ls-2">N2,449</h6>
                                        </div>                                
                                    </div>
                                </div>
