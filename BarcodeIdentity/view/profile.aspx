<%@ Page Title="" Language="C#" MasterPageFile="~/account/barcode.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="BarcodeIdentity.view.profile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>QrId - Personal ID Suite - Member Profile</title>
</asp:Content>
                        ...
                        <div class="col-xl-12 col-xxl-12 col-lg-12 pe-0">
                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3 mt-3">
                                        ...
                                        <div class="col-xl-10 ">
                                            <div class="row">
                                               ...
                                               <%-- <div class="col-lg-6 justify-content-md-center">
                                                    <span style="font-weight: 400; margin-left: 5px"><b>FRONT</b></span>
                                                    <div class="card w-100 border-0 shadow-none p-5 rounded-xxl mb-3" style="background-color: #e2f6e9; height: 200px">
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <img id="Img1" runat="server" src="/images/logobig.jpeg" style="height: 100px; width: 100px" alt="image"><br />
                                                            </div>
                                                            <div class="col-lg-6 ps-lg-5">
                                                               <h4 class="text-success font-lg fw-500" style="margin-left: -20px"> KeepFit</h4>
                                                <p class="font-xssss fw-500 text-grey-500 lh-26" style="margin-left:-20px; color:dimgray">Member</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>--%>
                                ...
                                <div class="card-body border-top-xs d-flex">
                                    <i class="feather-unlock text-grey-500 me-3 font-lg"></i>
                                    <h4 class="fw-700 text-grey-900 font-xssss mt-0">Public <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">This profile is available to public view</span></h4>
                                </div>
                                ...
                                <div class="card-body d-flex pt-0">
                                  ...
                                  <div class="card-body d-flex pt-0">
                                    ...
                                    <h4 class="fw-700 text-grey-900 font-xssss mt-1"> <%# ConfigurationManager.AppSettings["domainurl"]+"view/profile?mid="+ Eval("MemberUniqueId") %> </h4>
                                </div>
                                <div class="card-body d-flex pt-0">
                                    <i class="feather-users text-grey-500 me-3 font-lg"></i>
                                    <h4 class="fw-700 text-grey-900 font-xssss mt-1"><%# Eval("Role") %> Does not belong to any Group(s)</h4>
                                </div>
