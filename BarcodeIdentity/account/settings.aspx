<%@ Page Title="" Language="C#" MasterPageFile="~/account/barcode.Master" AutoEventWireup="true" CodeBehind="settings.aspx.cs" Inherits="BarcodeIdentity.account.settings" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>BarcodID - Personal ID Suite - Settings</title>
</asp:Content>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <ul class="list-inline mb-4">
                                            <li class="list-inline-item d-block border-bottom me-0"><a href="profile" class="pt-2 pb-2 d-flex align-items-center"><i class="btn-round-md bg-primary-gradiant text-white feather-home font-md me-3"></i> <h4 class="fw-600 font-xsss mb-0 mt-0">Acount Information</h4><i class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i></a></li>
                                            <li class="list-inline-item d-block border-bottom me-0"><a href="myqr" class="pt-2 pb-2 d-flex align-items-center"><i class="btn-round-md bg-gold-gradiant text-white feather-grid font-md me-3"></i> <h4 class="fw-600 font-xsss mb-0 mt-0">MyQRID</h4><i class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i></a></li>
