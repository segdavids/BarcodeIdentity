...
<head runat="server">
    ...
    <title>BarcodID - Personal ID Suite</title>
    ...
    <div class="main-wrap">
        ...
        <div class="nav-header bg-transparent shadow-none border-0">
            <div class="nav-top w-100">
                <a href="/"><i class="feather-grid text-success display1-size me-2 ms-0"></i><span class="d-inline-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">BarcodeID. </span> </a>
