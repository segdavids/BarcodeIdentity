<%@ Page Title="" Language="C#" MasterPageFile="~/account/barcode.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="BarcodeIdentity.account.profile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
         <title>QrId - Personal ID Suite - Admin Profile</title>
</asp:Content>
                    ...
                    <div class="middle-wrap">
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div class="card-body p-4 w-100 bg-current border-0 d-flex rounded-3">
                                ...
                                <h4 class="font-xs text-white fw-600 ms-4 mb-0 mt-2">Profile Information</h4>
                            </div>
                            ...
                            <div action="#">
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            <label class="mont-font fw-600 font-xsss">Last Login</label>
                                            <input type="text" id="Date1" disabled="disabled" runat="server" class="form-control">
                                        </div>        
                                    </div>

                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            <label class="mont-font fw-600 font-xsss">Date Created</label>
                                            <input type="date" id="dobtxt" disabled="disabled" runat="server" class="form-control">
                                        </div>        
                                    </div>
                                      <div class="col-lg-6 mb-3">
                                        <div class="form-group">
